...
class ClassesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'VCP279.map.ClassesTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('class_id', 'ClassId', 'VARCHAR', true, 10, null);
    ...
    {
        $this->addRelation('Enrollment', 'Enrollment', RelationMap::ONE_TO_MANY, array('id' => 'class_id', ), null, null, 'Enrollments');
    } // buildRelations()
