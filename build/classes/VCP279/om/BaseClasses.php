...
abstract class BaseClasses extends BaseObject implements Persistent
{
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ClassesPeer::ID;
        }
    ...
    public function setClassId($v)
    {
        ...
        if ($this->class_id !== $v) {
            $this->class_id = $v;
            $this->modifiedColumns[] = ClassesPeer::CLASS_ID;
        }
    ...
    public function setClassName($v)
    {
        ...
        if ($this->class_name !== $v) {
            $this->class_name = $v;
            $this->modifiedColumns[] = ClassesPeer::CLASS_NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->class_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 3; // 3 = ClassesPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ClassesPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ClassesPeer::CLASS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`class_id`';
        }
        if ($this->isColumnModified(ClassesPeer::CLASS_NAME)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':						
                        ...
                        break;
                    case '`class_id`':						
                        $stmt->bindValue($identifier, $this->class_id, PDO::PARAM_STR);
                        break;
                    case '`class_name`':						
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClassesPeer::ID)) $criteria->add(ClassesPeer::ID, $this->id);
        if ($this->isColumnModified(ClassesPeer::CLASS_ID)) $criteria->add(ClassesPeer::CLASS_ID, $this->class_id);
        if ($this->isColumnModified(ClassesPeer::CLASS_NAME)) $criteria->add(ClassesPeer::CLASS_NAME, $this->class_name);
    ...
    {
        $criteria = new Criteria(ClassesPeer::DATABASE_NAME);
        $criteria->add(ClassesPeer::ID, $this->id);
     ...
     * If this Classes is new, it will return
    ...
    public function setEnrollments(PropelCollection $enrollments, PropelPDO $con = null)
    {
        ...
        foreach ($enrollmentsToDelete as $enrollmentRemoved) {
            $enrollmentRemoved->setClasses(null);
        }
     ...
     * Otherwise if this Classes is new, it will return
     * an empty collection; or if this Classes has previously
     * been saved, it will retrieve related Enrollments from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Classes.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Enrollment[] List of Enrollment objects
     */
    public function getEnrollmentsJoinPerson($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = EnrollmentQuery::create(null, $criteria);
