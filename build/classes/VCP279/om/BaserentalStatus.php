...
/**
 * Base class that represents a row from the 'rental_status' table.
 *
 * 
 *
 * @package    propel.generator.VCP279.om
 */
abstract class BaserentalStatus extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'rentalStatusPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        rentalStatusPeer
     */
    ...
    public function getStatus()
    {
        ...
        $valueSet = rentalStatusPeer::getValueSet(rentalStatusPeer::STATUS);
     ...
     * @return rentalStatus The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = rentalStatusPeer::ID;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = rentalStatusPeer::STATUS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = rentalStatusPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating rentalStatus object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = rentalStatusPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = rentalStatusQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                rentalStatusPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(rentalStatusPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(rentalStatusPeer::STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`status`';
        }

        $sql = sprintf(
            'INSERT INTO `rental_status` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = rentalStatusPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = rentalStatusPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['rentalStatus'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['rentalStatus'][$this->getPrimaryKey()] = true;
        $keys = rentalStatusPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(rentalStatusPeer::ID)) $criteria->add(rentalStatusPeer::ID, $this->id);
        if ($this->isColumnModified(rentalStatusPeer::STATUS)) $criteria->add(rentalStatusPeer::STATUS, $this->status);
    ...
    {
        $criteria = new Criteria(rentalStatusPeer::DATABASE_NAME);
        $criteria->add(rentalStatusPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of rentalStatus (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return rentalStatus Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return rentalStatusPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new rentalStatusPeer();
        }
     ...
     * If this rentalStatus is new, it will return
    ...
    public function setRentalss(PropelCollection $rentalss, PropelPDO $con = null)
    {
        ...
        foreach ($rentalssToDelete as $rentalsRemoved) {
            $rentalsRemoved->setrentalStatus(null);
        }
     ...
     * Otherwise if this rentalStatus is new, it will return
     * an empty collection; or if this rentalStatus has previously
     * been saved, it will retrieve related Rentalss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in rentalStatus.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Rentals[] List of Rentals objects
     */
    public function getRentalssJoinEquipment($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = RentalsQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(rentalStatusPeer::DEFAULT_STRING_FORMAT);
    }
