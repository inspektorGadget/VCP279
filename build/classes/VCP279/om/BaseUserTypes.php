...
/**
 * Base class that represents a row from the 'user_types' table.
 *
 * 
 *
 * @package    propel.generator.VCP279.om
 */
abstract class BaseUserTypes extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'UserTypesPeer';
    ...
    /**
     * The value for the user_category field.
     * @var        int
     */
    ...
    /**
     * Get the [user_category] column value.
     * 
     * @return int
    ...
    {
        if (null === $this->user_category) {
            return null;
        }
        $valueSet = UserTypesPeer::getValueSet(UserTypesPeer::USER_CATEGORY);
        if (!isset($valueSet[$this->user_category])) {
            throw new PropelException('Unknown stored enum key: ' . $this->user_category);
        }

        return $valueSet[$this->user_category];
    }
     ...
     * @return UserTypes The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = UserTypesPeer::ID;
        }
    ...
    /**
     * Set the value of [user_category] column.
     * 
     * @param  int $v new value
     * @return UserTypes The current object (for fluent API support)
     * @throws PropelException - if the value is not accepted by this enum.
     */
    public function setUserCategory($v)
    {
        if ($v !== null) {
            $valueSet = UserTypesPeer::getValueSet(UserTypesPeer::USER_CATEGORY);
        ...
        if ($this->user_category !== $v) {
            $this->user_category = $v;
            $this->modifiedColumns[] = UserTypesPeer::USER_CATEGORY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->user_category = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = UserTypesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating UserTypes object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UserTypesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UserTypesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserTypesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserTypesPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(UserTypesPeer::USER_CATEGORY)) {
            $modifiedColumns[':p' . $index++]  = '`user_category`';
        }

        $sql = sprintf(
            'INSERT INTO `user_types` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':						
                        ...
                        break;
                    case '`user_category`':						
                        $stmt->bindValue($identifier, $this->user_category, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = UserTypesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = UserTypesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['UserTypes'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UserTypes'][$this->getPrimaryKey()] = true;
        $keys = UserTypesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getUserCategory(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setUserCategory($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTypesPeer::ID)) $criteria->add(UserTypesPeer::ID, $this->id);
        if ($this->isColumnModified(UserTypesPeer::USER_CATEGORY)) $criteria->add(UserTypesPeer::USER_CATEGORY, $this->user_category);
    ...
    {
        $criteria = new Criteria(UserTypesPeer::DATABASE_NAME);
        $criteria->add(UserTypesPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of UserTypes (or compatible) type.
    ...
    {
        $copyObj->setUserCategory($this->getUserCategory());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return UserTypes Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return UserTypesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new UserTypesPeer();
        }
     ...
     * If this UserTypes is new, it will return
    ...
    public function setPersons(PropelCollection $persons, PropelPDO $con = null)
    {
        ...
        foreach ($personsToDelete as $personRemoved) {
            $personRemoved->setUserTypes(null);
        }
    ...
    {
        return (string) $this->exportTo(UserTypesPeer::DEFAULT_STRING_FORMAT);
    }
